...
const member_routes_1 = __importDefault(require("./modules/member/routes/member.routes"));
const auth_routes_1 = __importDefault(require("./modules/member/routes/auth.routes"));
const course_routes_1 = __importDefault(require("./modules/course/routes/course.routes"));
const booking_routes_1 = __importDefault(require("./modules/booking/routes/booking.routes")); // Assuming the booking router is created
